...
% ============================================================
% subfigure 用法示例（多子图并排，含 (a)(b) 子标题）
% 用法：复制下方代码，将图片路径和标题替换为实际内容
% 此处用同一张占位图重复演示语法，实际使用时换成不同图片
% ============================================================
\begin{figure}[H]
  \centering
...
% ============================================================
% algorithm2e 用法示例（算法伪代码）
% 用法：复制下方代码，替换算法名称、输入输出和步骤内容
% ============================================================
\begin{algorithm}[H]
...
% ============================================================
% longtable 用法示例（跨页长表格，自动生成"续表 N"标题）
% 注意：longtable 不能嵌套在 table 浮动环境中，直接写在正文里
% 用法：复制下方代码，修改列格式、列数（\longtablecontinued{列数}）和内容
% ============================================================
